...
parser.add_argument("--suite", default="libero_complex", choices=["libero_spatial", "libero_object", "libero_goal", "libero_10", "libero_complex"],
...
parser.add_argument("--config", default='libero_vilt_diff', help="Then config name of yaml.")
...
task_dir_list.sort()
exp_name = 'dino_siglip_nowm4_1frame'
# dataset
...
for seed in range(1):
    commond = (f'python -m engine.train_bc_diff --config-name={CONFIG_NAME} train_gpus="{train_gpu_ids}" '

...
from libero.utils.env_utils import make_libero_env, make_libero_env2
...
def build_env(img_size, env_type, env_meta_fn=None, env_name=None, task_name=None,
              render_gpu_ids=-1, vec_env_num=1, seed=0, env_idx_start_end=None, make_env_type=1, **kwargs):
    """
    ...
    if make_env_type == 1:
        make_env_func = make_libero_env
    elif make_env_type == 2:
        make_env_func = make_libero_env2
    ...
    if env_type.lower() == "libero":
        ...
        for env_idx in range(idx_start, idx_end):
            ...
            env, task_embs = make_env_func(e_name, t_name, img_h, img_w, task_embedding=task_embedding,

...
parser.add_argument("--suite", default="libero_spatial", choices=["libero_spatial", "libero_object", "libero_goal", "libero_10"],
...
command = (f'python -m engine.eval_mv_bc_action --config-dir={exp_dir} --config-name=config hydra.run.dir=/tmp '
            f'+save_path={exp_dir} '
